"""
TESS - TRAIN 3 CLASSIFIERS (ENGINEERED FEATURES)
==================================================
Trains and compares:
...
Uses tess_processed.csv (14 engineered features + target)
...
print("="*80)
print("TESS - TRAINING 3 CLASSIFIERS (ENGINEERED FEATURES)")
print("="*80)
...
fig.suptitle('TESS - Model Comparison (XGBoost, Random Forest, SVM) - Engineered Features',
...
print("\n" + "="*80)
print("SUMMARY - TESS MODELS (ENGINEERED FEATURES)")
print("="*80)
